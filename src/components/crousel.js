...
import home1 from "../assets/img/carousel/4.jpg";
...
const Crousel = () => {
  ...
  return (
    <div className="crousel-component">
      <div
        className="tw-hidden min-[900px]:tw-grid tw-relative"
        style={{
          background:
        ...
        <Slider {...settings2} style={{ width: "100vw" }} ref={sliderRef}>
          ...
          <div>
            <div style={{ position: "relative" }}>
              ...
              <div className="overllay">
                <div className="florian">Florian Hurel</div>
                <div className="showreel2 ">
                  Makeup Artist
                  <br /> & Hair Specialist
                </div>
              </div>
          ...
          <div>
            <div style={{ position: "relative" }}>
              ...
              <div className="overllay">
                <div className="florian">Florian Hurel</div>
                <div className="showreel">SHOWREEL</div>
              </div>
            </div>
          </div>
        </Slider>
